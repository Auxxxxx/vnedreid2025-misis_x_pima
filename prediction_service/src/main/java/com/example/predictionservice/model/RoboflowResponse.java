...
@Schema(description = "Ответ от Roboflow API для анализа повреждений автомобиля")
public class RoboflowResponse {
    ...
    // Конструкторы
    public RoboflowResponse() {}

    public RoboflowResponse(String inferenceId, Double time, ImageInfo image, 
